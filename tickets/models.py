...
from .constants import (
    TICKET_TYPES, TICKET_STATUS, BERTH_TYPES, 
    AVAILABILITY_STATUS, HISTORY_ACTIONS
)
...
class Passenger(models.Model):
    ...
    age = models.IntegerField(
        ...
        help_text="Age of the passenger"
    )
    is_child = models.BooleanField(
        default=False,
        help_text="Indicates if passenger is under 5 years old"
    )
